...
var EventEmitter = require('events').EventEmitter,
    os = require('os'),
    LogFileWatcher = require('./log-file-watcher'),
    LogStreamWatcher = require('./log-stream-watcher');
 ...
 *
 * @param source stream or string with the log file path
...
var LogReader = function LogReader(source, pattern, fieldNames, opts) {
  ...
  if (typeof source === 'string') {
    this.logWatcher = new LogFileWatcher(source, pattern, fieldNames, opts);
  } else {
    this.logWatcher = new LogStreamWatcher(source, pattern, fieldNames, opts);
  }
};
